      ...
      <main class="max-w-7xl mx-auto px-4 py-8">
        ...
        @if (errorMessage() && !loading()) {
          <div class="bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex">
              ...
              <button (click)="loadConsultations()" class="text-red-600 hover:text-red-800 text-sm font-medium">
                Retry
              </button>
            </div>
          </div>
        ...
        @if (!loading() && consultations().length === 0 && !errorMessage()) {
          <div class="text-center py-12">
            ...
            <p class="mt-2 text-sm text-gray-500">Get started by creating your first consultation</p>
            <button 
              (click)="createNewConsultation()"
            ...
            @for (consultation of consultations(); track consultation.id) {
              <div 
                ...
                <div class="p-4 border-b bg-gray-50">
                  <div class="flex items-center justify-between">
                    <span class="text-sm font-medium text-gray-600">ID: {{ consultation.id }}</span>
                ...
                <div class="px-4 py-3 bg-gray-50 border-t">
                  <button 
                    (click)="viewConsultation(consultation.id); $event.stopPropagation()"
...
export class ConsultationsListPage implements OnInit {
  ...
  loadConsultations() {
    ...
    this.consultationService.getAll().subscribe({
      ...
      error: (error: any) => {
        this.errorMessage.set(error?.error?.detail || error?.message || 'Failed to load consultations');
